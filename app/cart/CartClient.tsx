              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-1 flex-wrap mt-0.5">
                    {variant && (
                      <span className="text-xs bg-amber-50 text-amber-700 px-1.5 py-0.5 rounded-full font-medium">{variant.label}</span>
                    )}
                    {addon && (
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border text-left transition-all ${
                        isFull
                          ...
                          : 'border-amber-100 bg-white hover:border-amber-200 hover:bg-amber-50'
                      }`}
                    >
