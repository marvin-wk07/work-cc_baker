  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-1 flex-wrap mt-0.5">
                    {variant && (
                      <span className="text-xs bg-orange-50 text-amber-700 px-1.5 py-0.5 rounded-full font-medium">{variant.label}</span>
                    )}
                    {addon && (
        ...
        <div className="px-5 py-4 bg-orange-50 flex justify-between items-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            {shippingDates.length === 0 ? (
              <div className="bg-orange-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-700">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border text-left transition-all ${
                        isFull
                          ...
                          : isSelected
                          ? 'border-amber-400 bg-orange-50 ring-2 ring-amber-200'
                          : 'border-amber-100 bg-white hover:border-amber-200 hover:bg-orange-50'
                      }`}
                    >
