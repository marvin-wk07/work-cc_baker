    ...
    <div className="bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
      ...
      <div className="p-3 flex flex-col flex-1 gap-2">
        <div className="flex items-start justify-between gap-1">
          ...
          <span className="text-xs bg-orange-50 text-amber-700 px-1.5 py-0.5 rounded-full whitespace-nowrap shrink-0">
            {product.category}
          </span>
        </div>
              ...
              <button
                ...
                className={`text-xs px-2.5 py-1 rounded-full font-medium transition-colors ${
                  selectedVariant?.label === v.label
                    ...
                    : 'bg-orange-50 text-amber-700 border border-amber-200 hover:bg-amber-100'
                }`}
              >
                {v.label}・NT${v.price}
              </button>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1 border border-amber-200 rounded-full overflow-hidden">
            <button
              ...
              disabled={qty <= minQty}
              className="w-7 h-7 flex items-center justify-center text-stone-600 hover:bg-orange-50 transition-colors font-bold disabled:opacity-30 disabled:cursor-not-allowed"
            >
              −
            </button>
