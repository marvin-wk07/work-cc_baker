    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-orange-300 via-orange-200 to-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/cart"
              className="border border-amber-200 text-amber-600 hover:bg-orange-200 px-8 py-3 rounded-full text-base transition-colors font-medium"
            >
              我的購物車
            </Link>
          </div>
      ...
      <section className="bg-amber-400 text-white py-12 px-4 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <Link
            href="/menu"
            className="inline-block bg-white text-amber-700 font-bold px-8 py-3 rounded-full hover:bg-orange-200 transition-colors"
          >
            立即選購
          </Link>
        </div>
